		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zsdmodulepooltmg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsdmodulepooltmg-display": {
								"semanticObject": "zsdmodulepooltmg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsdmodulepooltmg",
									"url": sap.ui.require.toUrl("zsdmodulepooltmg")
								}
							}
						}
					}

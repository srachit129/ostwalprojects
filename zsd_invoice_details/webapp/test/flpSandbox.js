		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zsdinvoicedetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsdinvoicedetails-display": {
								"semanticObject": "zsdinvoicedetails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsdinvoicedetails",
									"url": sap.ui.require.toUrl("zsdinvoicedetails")
								}
							}
						}
					}

						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zpaymentprogram-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zpaymentprogram-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpaymentprogram",
									"url": sap.ui.require.toUrl("zpaymentprogram")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zpurchasetmg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpurchasetmg-display": {
								"semanticObject": "zpurchasetmg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpurchasetmg",
									"url": sap.ui.require.toUrl("zpurchasetmg")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Parts Lifecycle",
									"targetURL": "#zpartslifecycle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpartslifecycle-display": {
								"semanticObject": "zpartslifecycle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpartslifecycle",
									"url": sap.ui.require.toUrl("zpartslifecycle")
								}
							}
						}
					}

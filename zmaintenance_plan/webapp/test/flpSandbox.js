		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zmaintenanceplan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmaintenanceplan-display": {
								"semanticObject": "zmaintenanceplan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmaintenanceplan",
									"url": sap.ui.require.toUrl("zmaintenanceplan")
								}
							}
						}
					}

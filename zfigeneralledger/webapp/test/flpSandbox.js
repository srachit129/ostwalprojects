		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zfigeneralledger-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfigeneralledger-display": {
								"semanticObject": "zfigeneralledger",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfigeneralledger",
									"url": sap.ui.require.toUrl("zfigeneralledger")
								}
							}
						}
					}

		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zpaymentadvice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpaymentadvice-display": {
								"semanticObject": "zpaymentadvice",
								"action": "display",
								"description": "Payment Advice Print",
								"title": "Payment Advice",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpaymentadvice",
									"url": sap.ui.require.toUrl("zpaymentadvice")
								}
							}
						}
					}

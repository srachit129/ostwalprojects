		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "M",
									"targetURL": "#zfimiroprint-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfimiroprint-display": {
								"semanticObject": "zfimiroprint",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfimiroprint",
									"url": sap.ui.require.toUrl("zfimiroprint")
								}
							}
						}
					}

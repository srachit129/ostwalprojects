		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zquantitydiscountmodulepool-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zquantitydiscountmodulepool-display": {
								"semanticObject": "zquantitydiscountmodulepool",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zquantitydiscountmodulepool",
									"url": sap.ui.require.toUrl("zquantitydiscountmodulepool")
								}
							}
						}
					}

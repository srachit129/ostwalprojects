		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lifting Discount",
									"targetURL": "#zliftingdiscounttmg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zliftingdiscounttmg-display": {
								"semanticObject": "zliftingdiscounttmg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zliftingdiscounttmg",
									"url": sap.ui.require.toUrl("zliftingdiscounttmg")
								}
							}
						}
					}

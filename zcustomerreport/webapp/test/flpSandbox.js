		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zcustomerreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcustomerreport-display": {
								"semanticObject": "zcustomerreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcustomerreport",
									"url": sap.ui.require.toUrl("zcustomerreport")
								}
							}
						}
					}

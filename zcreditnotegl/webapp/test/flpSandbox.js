		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Credit Note GL",
									"targetURL": "#zcreditnotegl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcreditnotegl-display": {
								"semanticObject": "zcreditnotegl",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcreditnotegl",
									"url": sap.ui.require.toUrl("zcreditnotegl")
								}
							}
						}
					}

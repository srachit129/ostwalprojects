		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zquantitydiscounttmg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zquantitydiscounttmg-display": {
								"semanticObject": "zquantitydiscounttmg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zquantitydiscounttmg",
									"url": sap.ui.require.toUrl("zquantitydiscounttmg")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Finance Prints",
									"targetURL": "#zcreditdebitnote-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcreditdebitnote-display": {
								"semanticObject": "zcreditdebitnote",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcreditdebitnote",
									"url": sap.ui.require.toUrl("zcreditdebitnote")
								}
							}
						}
					}

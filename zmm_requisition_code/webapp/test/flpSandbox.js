		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zmmrequisitioncode-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmmrequisitioncode-display": {
								"semanticObject": "zmmrequisitioncode",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmmrequisitioncode",
									"url": sap.ui.require.toUrl("zmmrequisitioncode")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cash Discount",
									"targetURL": "#zcashdiscountmodulepool-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcashdiscountmodulepool-display": {
								"semanticObject": "zcashdiscountmodulepool",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcashdiscountmodulepool",
									"url": sap.ui.require.toUrl("zcashdiscountmodulepool")
								}
							}
						}
					}

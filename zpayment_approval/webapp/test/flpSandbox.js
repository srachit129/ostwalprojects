						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zpaymentapproval-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zpaymentapproval-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpaymentapproval",
									"url": sap.ui.require.toUrl("zpaymentapproval")
								}
							}
						}
					}

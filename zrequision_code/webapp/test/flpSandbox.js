		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Requision C",
									"targetURL": "#zrequisioncode-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zrequisioncode-display": {
								"semanticObject": "zrequisioncode",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zrequisioncode",
									"url": sap.ui.require.toUrl("zrequisioncode")
								}
							}
						}
					}

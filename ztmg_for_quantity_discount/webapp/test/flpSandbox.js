		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ztmgforquantitydiscount-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ztmgforquantitydiscount-display": {
								"semanticObject": "ztmgforquantitydiscount",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ztmgforquantitydiscount",
									"url": sap.ui.require.toUrl("ztmgforquantitydiscount")
								}
							}
						}
					}

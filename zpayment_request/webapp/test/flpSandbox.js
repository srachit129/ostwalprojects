		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zpaymentrequest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpaymentrequest-display": {
								"semanticObject": "zpaymentrequest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpaymentrequest",
									"url": sap.ui.require.toUrl("zpaymentrequest")
								}
							}
						}
					}

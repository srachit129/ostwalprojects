		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "General ",
									"targetURL": "#zgeneraldiscounttmg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zgeneraldiscounttmg-display": {
								"semanticObject": "zgeneraldiscounttmg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zgeneraldiscounttmg",
									"url": sap.ui.require.toUrl("zgeneraldiscounttmg")
								}
							}
						}
					}

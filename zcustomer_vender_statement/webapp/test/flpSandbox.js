		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zcustomervenderstatement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcustomervenderstatement-display": {
								"semanticObject": "zcustomervenderstatement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcustomervenderstatement",
									"url": sap.ui.require.toUrl("zcustomervenderstatement")
								}
							}
						}
					}

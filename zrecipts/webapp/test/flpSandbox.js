		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Recipts",
									"targetURL": "#reciptszrecipts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"reciptszrecipts-display": {
								"semanticObject": "reciptszrecipts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=recipts.zrecipts",
									"url": sap.ui.require.toUrl("recipts/zrecipts")
								}
							}
						}
					}

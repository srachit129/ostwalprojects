		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Maintain Circular Number",
									"targetURL": "#zmaintaincirculartmg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmaintaincirculartmg-display": {
								"semanticObject": "zmaintaincirculartmg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmaintaincirculartmg",
									"url": sap.ui.require.toUrl("zmaintaincirculartmg")
								}
							}
						}
					}

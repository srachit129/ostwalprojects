		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Circular ",
									"targetURL": "#zcircularnumbertmg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcircularnumbertmg-display": {
								"semanticObject": "zcircularnumbertmg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcircularnumbertmg",
									"url": sap.ui.require.toUrl("zcircularnumbertmg")
								}
							}
						}
					}

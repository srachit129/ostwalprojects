		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zqualityassurance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zqualityassurance-display": {
								"semanticObject": "zqualityassurance",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zqualityassurance",
									"url": sap.ui.require.toUrl("zqualityassurance")
								}
							}
						}
					}
